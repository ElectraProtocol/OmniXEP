...
static const CRPCConvertParam vRPCConvertParams[] =
{
    ...
    { "omni_sendadddelegate", 1, "propertyid" },
    { "omni_sendremovedelegate", 1, "propertyid" },
    ...
    { "omni_createpayload_adddelegate", 0, "propertyid" },
    { "omni_createpayload_removedelegate", 0, "propertyid" },
